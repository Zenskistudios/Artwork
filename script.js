...
const dom = {
  ...
  audioToggle: document.getElementById("audio_toggle"),
...
// Set up Web Audio API for volume boost beyond 100%
const initAudioContext = () => {
  if (audioContext) return;
  audioContext = new (window.AudioContext || window.webkitAudioContext)();
  const source = audioContext.createMediaElementAudioSource(dom.bgMusic);
  gainNode = audioContext.createGain();
  gainNode.gain.value = 1.2; // 120% volume
